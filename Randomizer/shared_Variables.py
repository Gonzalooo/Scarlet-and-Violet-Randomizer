...
legends = [144, 145, 146, 150, 151, 243, 244, 245, 249, 250, 251, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386, 480,
           ...
           1011, 1014, 1015, 1016, 1017, 1018, 1019, 1020, 1021, 1022] # Fix numbers to match national dex
legends_and_paradox = [
           ...
           1016, 1021, 1022] # Fix numbers to match national dex
...
# Fix numbers to match national dex
...
has_alternate_form = [25,  # Pikachu - Caps + Partner
                      ...
                      917,  # Dudunsparce - Three Segment
                      934,  # Palafin - Hero
                      946,  # Mausehold - 3-Family
                      952,  # Tatsugiri - Flavors [1-2]
                      960,  # Squakabily - Colors [1-3]
                      976,  # Gimmighoul - Roaming
                      998,  # Koraidon [0 - Apex]
                      999,  # Miraidon [0 - Ultimate]
                      1011,  # Ogerpon - 0 [Teal], 1[wellspring], 2[heartflame], 3[rock]; 4-7 is teraform
                      1021,  # Terapagos - 2 is Teraform
                      1024,  # Poltchageist - Marked
                      1025,  # Sinistcha - Marked
    ]